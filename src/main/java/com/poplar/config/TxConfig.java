 ...
 *   利用TransactionManagementConfigurationSelector给容器中会导入组件导入两个组件
 *      AutoProxyRegistrar
 ...
 *          事务拦截器:
 *              1)、先获取事务相关的属性
 *              2)、再获取 PlatformTransactionManager, 如果事先没有添加指定任何 transactionManger最终会从容器中按照类型获取一个PlatformTransactionManager;
 *              3)、执行目标方法
...
@ComponentScan(basePackages = "com.poplar.dao")
